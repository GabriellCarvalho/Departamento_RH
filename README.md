...
1. Clone este repositório:
   ...
   ```
2. Abra o arquivo `departamento-de-rh.ipynb` no Jupyter Notebook, JupyterLab ou no Kaggle.
...
[GitHub](https://github.com/GabriellCarvalho) | [Kaggle](https://www.kaggle.com/gabriellopescarvalho)
